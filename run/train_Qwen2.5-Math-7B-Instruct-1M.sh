...
MODEL_PATH=/pri_exthome/Mamba/Model/Qwen/Qwen2.5-7B-Instruct-1M
DATASET_PATH=parquet@/pri_exthome/Mamba/Dataset/General/OpenR1-Math-220k-ChatML-V2
OUTPUT_DIR=/mnt/pri_public/Mamba/Project/OpenRLHF-R1/$MODEL_NAME/SFT/OpenR1-Math-220k_8K
...
WANDB_RUN_NAME=${MODEL_NAME}_OpenR1-Math-220k_8K_${TIMESTAMP}
