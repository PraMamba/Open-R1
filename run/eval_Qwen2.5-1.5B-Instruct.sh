...
# NUM_GPUS=8
# MODEL=/pri_exthome/Mamba/Project/Open-R1/Qwen2.5-1.5B-Instruct/GRPO/checkpoint-30
# MODEL_ARGS="pretrained=$MODEL,dtype=bfloat16,data_parallel_size=$NUM_GPUS,max_model_length=32768,gpu_memory_utilisation=0.8"
# OUTPUT_DIR=/pri_exthome/Mamba/Project/Open-R1/Qwen2.5-1.5B-Instruct/GRPO_Eval/checkpoint-30/$TASK_NAME/
